/* 
 * $Id: CommandLineParameters.h 101 2013-05-30 12:56:35Z mzbjyza2mji4zgz $
 */
...
private:
    __rcsId("$Id: CommandLineParameters.h 101 2013-05-30 12:56:35Z mzbjyza2mji4zgz $");
...
private:
    ...
    pParse(int argc, char * const argv[]) {
        bool ret = false;
        mNewArgv = (const char **)malloc(sizeof(const char *) * (size_t)argc);
        if (mNewArgv == NULL) {
...
public:
    ...
    inline void
    getUnparsedOptions(int &argc, char const * const * &argv) {
        argc = mNewArgc;
        argv = (char const * const *)mNewArgv;
    }
