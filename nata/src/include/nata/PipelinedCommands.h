/* 
 * $Id: PipelinedCommands.h 99 2013-01-25 17:09:27Z mzbjyza2mji4zgz $
 */
...
private:
    ...
    __rcsId("$Id: PipelinedCommands.h 99 2013-01-25 17:09:27Z mzbjyza2mji4zgz $");
    ...
    mFd2Path(int fd) {
        ...
        if (fd >= 0) {
            ...
            if (lstat(path, &st) == 0 &&
                ...
                if (l >= 0) {
                    l = (l < (ssize_t)(sizeof(realPath) - 1)) ? 
                        l : (ssize_t)(sizeof(realPath) - 1);
                    realPath[l] = '\0';
                    ret = strdup(realPath);
                }
            }
