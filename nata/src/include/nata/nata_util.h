/* 
 * $Id: nata_util.h 99 2013-01-25 17:09:27Z mzbjyza2mji4zgz $
 */
...
extern _BOOL_		nata_ParseLongDouble(const char *str,
                                             long double *val);
extern _BOOL_		nata_ParseBool(const char *str, _BOOL_ *val);
...
extern _BOOL_		nata_TTYSetBaudRate(int ttyfd, unsigned int rate);
 ...
 * nanosleep
 */
extern void		nata_NanoSleep(uint64_t nSec);
